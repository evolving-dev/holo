FONTS = {
"h1": pygame.font.Font(os.path.join(PATH,"assets/fonts/Bebas_Neue/BebasNeue-Regular.ttf"), SETTINGS["width"]//12),
"h2": pygame.font.Font(os.path.join(PATH,"assets/fonts/Poppins/Poppins-Regular.ttf"), SETTINGS["width"]//20),
"h3": pygame.font.Font(os.path.join(PATH,"assets/fonts/Poppins/Poppins-Medium.ttf"), SETTINGS["width"]//25),
...
"p-small-sans-serif": pygame.font.Font(os.path.join(PATH,"assets/fonts/Roboto/Roboto-Thin.ttf"), SETTINGS["width"]//50),
