...
SETTINGS = {"width":int(INITFILE[0]),"height":int(INITFILE[1]),"lang":"en-US",'background':'standard.png','theme':'dark','timeout':120,'keyboard':'qwerty','timeformat': '%H:%M:%S','dateformat':'%d.%m.%Y'}
