STATIC_CORE: dict = {
"background":pygame.image.fromstring(holo.drawOptimize(Image.open(join(PATH,join("assets/images/backgrounds",SETTINGS["background"]+".png"))).resize((SETTINGS["width"],SETTINGS["height"])).convert("RGB")),(SETTINGS["width"],SETTINGS["height"]),"RGB").convert(),
