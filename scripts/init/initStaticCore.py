...
"back": pygame.image.fromstring(Image.open(holo.path("assets/images/icons/buttons/back/back-"+SETTINGS["theme"]+".png")).resize((SETTINGS["height"]//12,SETTINGS["height"]//12)).tobytes(),(SETTINGS["height"]//12,SETTINGS["height"]//12),"RGBA").convert_alpha(),
