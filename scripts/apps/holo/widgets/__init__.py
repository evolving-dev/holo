...
data["assets"] = {
    ...
    "add": holo_gui.load_image(join(APP_PATH["assets"], "icons/add-"+SETTINGS["theme"]+".png"),(SETTINGS["height"]//12,SETTINGS["height"]//12)),
    "delete": holo_gui.load_image(join(APP_PATH["assets"], "icons/delete-"+SETTINGS["theme"]+".png"), (SETTINGS["height"]//12,SETTINGS["height"]//12)),
...
if not os.path.isfile(holo_io.path.to_absolute("storage/system/widgets")):
